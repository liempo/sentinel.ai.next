      ...
      <header className="px-5 py-4">
        <div className="flex justify-between items-center">
          ...
          <div className="form-check form-switch">
            <input
              className="form-check-input appearance-none w-9 rounded-full float-left h-5 align-top text-green-600 bg-white bg-no-repeat bg-contain border-gray-700 focus:outline-none cursor-pointer shadow-sm"
              type="checkbox"
              role="switch"
              id="cameraSwitch"
              onChange={(e) => {
